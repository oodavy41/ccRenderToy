System.register(["./glfuncs", "./GL", "./loader", "./object/Material", "./baseModels"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var glfuncs_1, GL_1, loader_1, Material_1, baseModels_1;
    return {
        setters: [
            ...
            function (baseModels_1_1) {
                baseModels_1 = baseModels_1_1;
            }
        ],
        execute: function () {
            window.onload = function () {
                ...
                //----------------------------------
                var objs1 = loader_1.objLoader(resPah + 'models/mwzz/', 'mwzz.obj', thegl.mtllib, thegl.gl, 'anim_phone');
                var objs11 = loader_1.objLoader(resPah + 'models/mwzz/', 'mwzz.obj', thegl.mtllib, thegl.gl, 'anim_edge_phone');
                ...
                //----------------------------------
                var objs2 = loader_1.objLoader(resPah + 'models/mwzz/', 'mwzz.obj', thegl.mtllib, thegl.gl, 'text_phone');
                glfuncs_1.set_obj_info(objs2, function (tran) {
                    tran.set_pos(0, 0, 2);
                });
                //----------------------------------
                var objsrefl = loader_1.objLoader(resPah + 'models/mwzz/', 'mwzz.obj', thegl.mtllib, thegl.gl, 'reflect_mat');
                ...
                //----------------------------------
                var objsrefr = loader_1.objLoader(resPah + 'models/mwzz/', 'mwzz.obj', thegl.mtllib, thegl.gl, 'refract_mat');
